...
@XmlRootElement(name = "multiplierResponse", namespace = "http://localhost:9000/CalculatriceService")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "multiplierResponse", namespace = "http://localhost:9000/CalculatriceService")
