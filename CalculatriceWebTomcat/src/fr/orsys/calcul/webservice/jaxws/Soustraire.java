...
@XmlRootElement(name = "soustraire", namespace = "http://localhost:9000/CalculatriceService")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "soustraire", namespace = "http://localhost:9000/CalculatriceService", propOrder = {"arg0", "arg1"})
