...
public class CalculatriceServiceLocator extends org.apache.axis.client.Service implements fr.carsat.service.soap.rpc.CalculatriceService {
    ...
    private java.lang.String CalculatriceServicePort_address = "http://192.168.8.3:9000/CalculatriceWebService";
    ...
    public fr.carsat.service.soap.rpc.CalculatriceContrat getCalculatriceServicePort() throws javax.xml.rpc.ServiceException {
    ...
    public fr.carsat.service.soap.rpc.CalculatriceContrat getCalculatriceServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            fr.carsat.service.soap.rpc.CalculatriceServicePortBindingStub _stub = new fr.carsat.service.soap.rpc.CalculatriceServicePortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (fr.carsat.service.soap.rpc.CalculatriceContrat.class.isAssignableFrom(serviceEndpointInterface)) {
                fr.carsat.service.soap.rpc.CalculatriceServicePortBindingStub _stub = new fr.carsat.service.soap.rpc.CalculatriceServicePortBindingStub(new java.net.URL(CalculatriceServicePort_address), this);
                _stub.setPortName(getCalculatriceServicePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://rpc.soap.service.carsat.fr/", "CalculatriceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://rpc.soap.service.carsat.fr/", "CalculatriceServicePort"));
        }
